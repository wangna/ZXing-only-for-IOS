...
- (void)drawRect:(CGRect)rect {
  ...
  if (displayedMessage == nil) {
    self.displayedMessage = NSLocalizedStringWithDefaultValue(@"OverlayView displayed message", nil, [NSBundle mainBundle], @"Scan this every day for a new inspiration", @"Place a barcode inside the viewfinder rectangle to scan it.");
  }
